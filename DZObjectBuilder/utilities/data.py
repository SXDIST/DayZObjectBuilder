...
common_data = {
    "proxies": {
        "Vehicle: driver": r"DZ\vehicles\wheeled\proxies\Crew_Driver.p3d",
        "Vehicle: cargo": r"DZ\vehicles\wheeled\proxies\Crew_Cargo.p3d",
        "Weapon: magazine": r"DZ\weapons\proxies\magazine.p3d",
        "Back: rifle (AK)": r"DZ\characters\proxies\ak_47_v58_proxy.p3d",
        "Back: launcher (RPG-7)": r"DZ\characters\proxies\RPG7_proxy.p3d",
        "Back: binoculars": r"DZ\characters\proxies\dalekohled_proxy.p3d"
    },
    "namedprops": {
        "autocenter": "0",
        "buoyancy": "1",
    ...
    "materials_penetration": {
        "Armour": r"DZ\data\data\Penetration\armour.rvmat",
        "Armor plate 1mm": r"DZ\data\data\Penetration\armor_1mm_plate.rvmat",
        "Armor plate 3mm": r"DZ\data\data\Penetration\armor_3mm_plate.rvmat",
        "Armor plate 5mm": r"DZ\data\data\Penetration\armor_5mm_plate.rvmat",
        "Armor plate 7mm": r"DZ\data\data\Penetration\armor_7mm_plate.rvmat",
        "Armor plate 11mm": r"DZ\data\data\Penetration\armor_11mm_plate.rvmat",
        "Armor plate 16mm": r"DZ\data\data\Penetration\armor_16mm_plate.rvmat",
        "Armor plate 23mm": r"DZ\data\data\Penetration\armor_23mm_plate.rvmat",
        "Armor plate 30mm": r"DZ\data\data\Penetration\armor_30mm_plate.rvmat",
        "Bricks": r"DZ\data\data\Penetration\bricks.rvmat",
        "Cast iron": r"DZ\data\data\Penetration\castiron.rvmat",
        "Cast iron plate": r"DZ\data\data\Penetration\castironplate.rvmat",
        "Cloth": r"DZ\data\data\Penetration\cloth.rvmat",
        "Concrete": r"DZ\data\data\Penetration\concrete.rvmat",
        "Conifer foliage": r"DZ\data\data\Penetration\coniferfoliage.rvmat",
        "Cushion": r"DZ\data\data\Penetration\cushion.rvmat",
        "Dirt": r"DZ\data\data\Penetration\dirt.rvmat",
        "Explosion (transparent)": r"DZ\data\data\Penetration\explosiontransparent.rvmat",
        "Fabric": r"DZ\data\data\Penetration\fabricp.rvmat",
        "Fabric (thin)": r"DZ\data\data\Penetration\fabric_thin.rvmat",
        "Foliage": r"DZ\data\data\Penetration\foliage.rvmat",
        "Foliage (green)": r"DZ\data\data\Penetration\foliage_green.rvmat",
        "Glass": r"DZ\data\data\Penetration\glass.rvmat",
        "Glass (armored)": r"DZ\data\data\Penetration\glass_armored.rvmat",
        "Glass (house)": r"DZ\data\data\Penetration\glass_house.rvmat",
        "Glass (impenetrable)": r"DZ\data\data\Penetration\glass_impenetrable.rvmat",
        "Glass plate": r"DZ\data\data\Penetration\glassplate.rvmat",
        "Granite": r"DZ\data\data\Penetration\granite.rvmat",
        "Hay": r"DZ\data\data\Penetration\hay.rvmat",
        "Ice": r"DZ\data\data\Penetration\ice.rvmat",
        "Iron": r"DZ\data\data\Penetration\iron.rvmat",
        "Iron plate": r"DZ\data\data\Penetration\ironplate.rvmat",
        "Leather": r"DZ\data\data\Penetration\leather.rvmat",
        "Mattress": r"DZ\data\data\Penetration\mattress.rvmat",
        "Meat (limbs)": r"DZ\data\data\Penetration\meat.rvmat",
        "Meat + bones (body)": r"DZ\data\data\Penetration\meatbones.rvmat",
        "Metal plate": r"DZ\data\data\Penetration\metalplate.rvmat",
        "Metal plate (fence)": r"DZ\data\data\Penetration\metalplatefence.rvmat",
        "Plastic": r"DZ\data\data\Penetration\plastic.rvmat",
        "Plastic (material)": r"DZ\data\data\Penetration\plastic_material.rvmat",
        "Plexi plate": r"DZ\data\data\Penetration\plexiplate.rvmat",
        "Pottery": r"DZ\data\data\Penetration\pottery.rvmat",
        "Rubber": r"DZ\data\data\Penetration\rubber.rvmat",
        "Rubber plate": r"DZ\data\data\Penetration\rubberplate.rvmat",
        "Snow": r"DZ\data\data\Penetration\snow.rvmat",
        "Thin wire": r"DZ\data\data\Penetration\thin_wire.rvmat",
        "Weapon lift": r"DZ\data\data\Penetration\weaponlift.rvmat",
        "Wood": r"DZ\data\data\Penetration\wood.rvmat",
        "Wood (desk)": r"DZ\data\data\Penetration\wood_desk.rvmat"
    },
    "procedurals": {
